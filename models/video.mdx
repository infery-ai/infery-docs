...
| `id-v2v` | id-v2v | — | Restyle a video’s scene, lighting, and visual style from edited keyframes while preserving the source subjects’ identity, expressions… |
| `id-v2v-relight` | id-v2v | — | Change a video’s lighting using a relit reference frame while preserving the scene, subjects, and original performance. |
