...
**93 models.** Grouped by input, because that is the choice you make first — a model that
...
| `gemini-3.8-flash-lite-tts` | google | — | Generate expressive speech with Gemini 3.8 Flash Lite TTS. |
| `gemini-3.8-flash-tts` | google | — | Generate expressive speech with Gemini 3.8 Flash TTS. |
...
| `tts-1` | openai | — |  |
| `tts-1-hd` | openai | — |  |
| `chatterbox` | resemble-ai | Audio | Resemble Chatterbox is Resemble AI's first production-grade open source text to speech model. |
...
| `grok-voice` | xai | — | Build real-time voice applications powered by Grok. Send recorded audio and get a voice and text response. |
| `grok-voice-realtime` | xai | — | Build real-time voice applications powered by Grok. |
