...
**44 models.** Grouped by input, because that is the choice you make first — a model that
...
| `music-v2` | elevenlabs | — | Generate high quality, realistic music with fine controls using Elevenlabs Music v2! |
| `music-v2.5` | elevenlabs | — | Generate high quality, realistic music with fine controls using Elevenlabs Music v2.5! |
...
| `lyria-3.5` | google | — | Lyria 3.5 is Google DeepMind's latest music generation model, and you can generate almost any type of music with it |
